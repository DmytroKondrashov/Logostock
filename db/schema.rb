...
ActiveRecord::Schema[7.0].define(version: 2023_10_05_113809) do
  ...
  create_table "csv_uploads", force: :cascade do |t|
    ...
    t.jsonb "companies_applied", default: "{}", null: false
    t.jsonb "companies_failed", default: "{}", null: false
    t.jsonb "companies_discarded", default: "{}", null: false
